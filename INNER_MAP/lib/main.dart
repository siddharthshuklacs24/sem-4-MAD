...
class _MapScreenState extends State<MapScreen> {
  ...
  void calculatePathIfReady() {
    if (startNodeId != null && endNodeId != null) {
      ...
      final newPath = PathService.findPath(startNodeId!, endNodeId!, connections);

      setState(() {
        path = newPath;
        // 🚀 SMART JUMP: Automatically switch to the floor of the 'From' node
        if (path.isNotEmpty) {
          final startNode = nodes.firstWhereOrNull((n) => n.id == path.first);
          if (startNode != null) {
